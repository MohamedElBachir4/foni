...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/iphone`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    { url: `${siteUrl}/samsung`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    { url: `${siteUrl}/afficheur`, lastModified: now, changeFrequency: "daily", priority: 0.85 },
