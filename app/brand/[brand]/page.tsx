      ...
      <main className="mx-auto max-w-7xl px-4 pb-20 pt-24 sm:px-6 sm:pt-28 lg:px-8">
        <header className="mb-10 sm:mb-12">
          <nav className="mb-3 flex items-center gap-2 text-xs text-slate-500 sm:text-sm">
            ...
            <span className="font-medium text-slate-700">{brandLabel}</span>
          </nav>
          <h1 className="text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">
            اختر القسم داخل {brandLabel}
          </h1>
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-600 sm:text-base">
            اختر ما تريد استعراضه من هذه الماركة: الهواتف، الأكسسوارات، أو قطع الغيار.
          </p>
        </header>

        <section className="mx-auto grid max-w-4xl grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-6">
          <Link
            href={`/brand/${brandId}/phones`}
          ...
          >
            ...
            <div className="px-3 py-3 text-center">
              ...
              <p className="mt-1 text-[11px] text-slate-500 sm:text-xs">
                اكتشف هواتف {brandLabel} المتوفرة لدينا.
              </p>
            </div>
          </Link>

          <Link
            href={`/brand/${brandId}/accessories`}
            className="group flex flex-col overflow-hidden rounded-2xl border-0 bg-white text-gray-700 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-md"
          >
            <div className="aspect-[4/3] w-full overflow-hidden bg-gray-100">
              <img
                src="https://i.pinimg.com/736x/a1/f6/e2/a1f6e266de71fe64b1eb4a68b91c00ee.jpg"
                alt={`أكسسوارات ${brandLabel}`}
                className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105"
              />
            </div>
            <div className="px-3 py-3 text-center">
              ...
              <p className="mt-1 text-[11px] text-slate-500 sm:text-xs">
                جرابات، شواحن وسماعات لهواتف {brandLabel}.
              </p>
            </div>
          </Link>

          <Link
            href={`/brand/${brandId}/spare-parts`}
            className="group flex flex-col overflow-hidden rounded-2xl border-0 bg-white text-gray-700 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-md"
          >
            <div className="aspect-[4/3] w-full overflow-hidden bg-gray-100">
              <img
                src="https://i.pinimg.com/736x/02/c2/62/02c262e51afde8e065fc64aac01eb378.jpg"
                alt={`قطع غيار ${brandLabel}`}
                className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105"
              />
            </div>
            <div className="px-3 py-3 text-center">
              ...
              <p className="mt-1 text-[11px] text-slate-500 sm:text-xs">
                شاشات، بطاريات وقطع داخلية لهواتف {brandLabel}.
              </p>
            </div>
          </Link>
        </section>
